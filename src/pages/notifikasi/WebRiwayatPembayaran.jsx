...
export const WebRiwayatPembayaran = () => {
  ...
  const dataPayment = useSelector(
    (state) => state.PaymentHistory.paymentHistory.enrollments
  );
      ...
      <div className="flex justify-center items-center mobile:mt-0 desktop:mt-[-4rem] ">
        <div className="w-[65%] h-[37rem] flex border border-[#116E63] rounded-md flex-col mobile:w-full desktop:w-[65%]  mobile:h-screen desktop:h-[33rem] ">
          <div className="w-full bg-[#116E63] py-4 flex justify-center items-center">
            <h1 className="text-white font-bold text-2xl mobile:pl-4 desktop:pl-0 ">
              Akun
            </h1>
          </div>
              ...
              {dataPayment &&
                dataPayment.map((history) => (
                  <div className="w-80 snap-start h-fit shadow-lg rounded-3xl pt-4 ">
                    <img
                      className="w-full h-[5rem] bg-cover rounded-t-3xl"
                      src={history.course.category[0].category.image}
                    />
                    <div className="px-2 py-1 space-y-1 ">
                      <div className="flex justify-between text-sm ">
                        <p className="text-[#116E63] font-bold">
                          {history.course.category[0].category.name}
                        </p>
                      ...
                      <p className="text-xs">
                        {history.course.mentor[0].mentor.name}
                      </p>
