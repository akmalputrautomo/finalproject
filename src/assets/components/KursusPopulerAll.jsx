            ...
            <div key={courseAll}>
              <Link to={`/detailKelas/${courseAll.course_id}`}>
                <div className="w-full h-52 shadow-lg rounded-3xl">
                  <img
                    className="w-full h-2/5 bg-cover rounded-t-3xl"
                    src={courseAll.course.image}
                  />
                  <div className="px-2 py-1 space-y-1 ">
                    <div className="flex justify-between text-sm ">
                      <p className="text-[#116E63] font-bold">
                        {courseAll.category.name}
                      </p>
