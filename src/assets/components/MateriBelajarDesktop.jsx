        ...
        <div className="flex h-full  justify-center content-center items-center ">
          <div className=" space-y-4 w-full mx-6 ">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <p className="font-medium text-[#116E63]">{progres.toFixed(0)}%</p>
              <Progress
                aria-label="Loading..."
                value={progres}
                className="max-w-md"
                  ...
                  <div className="space-y-2 my-2">
                    {courses.lessons.map((lesson, lessonIndex) => {
                      const cumulativeLessonIndex =
                        dataDetail.chapter
                          .slice(0, indeks)
                          .reduce((total, ch) => total + ch.lessons.length, 0) +
                        lessonIndex +
                        1;
