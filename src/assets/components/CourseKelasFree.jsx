...
export const CourseKelasFree = () => {
  return (
    <div>
      ...
      {/* card 1 */}
        <div className="w-[50%] h-52 shadow-lg rounded-3xl">
          ...
          <div className="px-2 py-3 space-y-1 bg-white rounded-b-3xl">
            ...
            <div className="flex text-xs font-normal gap-10">
              <div className="flex items-center gap-1">
                <img src={level}/>
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-white rounded-full bg-[#116E63] w-[30%]">
              <p>Mulai Kelas</p>
            </div>
          </div>
        </div>
