...
<<<<<<< HEAD
export const CourseKelasAll = ({ FilteredCourses }) => {
  return (
      ...
      <div className="grid grid-cols-1 desktop:grid-cols-2 gap-[3rem] desktop:gap-[2rem]">
        ...
        {FilteredCourses &&
          FilteredCourses.map((courses) => (
            <div key={courses.course_id} className="h-[16rem] bg-white shadow-lg rounded-3xl">
              <img src={courses.course.image} className="bg-emerald-500 w-full h-2/5 rounded-t-3xl "></img>
              <div className="px-2 py-3 space-y-1 rounded-b-3xl">
                ...
                <p className="text-xs">by {courses.course.mentor[0].mentor.name}</p>
...
>>>>>>> fde2cd7774d6376f6408c26e583d2a29846ccbaf
                  </div>
                </div>
              ))}
          </div>
