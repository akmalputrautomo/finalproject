  ...
  return (
    <div className="py-5 px-[1rem] desktop:px-16">
      ...
      <div className="flex justify-between py-6 gap-3 desktop:gap-6">
        <Button onClick={() => handleBtn('All')} className={`bg-white w-[25%] ${activeButton === 'All' && 'bg-[#116E63] text-white'}`}>All</Button>
        <Button onClick={() => handleBtn('Premium')} className={`bg-white w-[40%] ${activeButton === 'Premium' && 'bg-[#116E63] text-white'}`}>Kelas Premium</Button>
        <Button onClick={() => handleBtn('Free')} className={`bg-white w-[35%] ${activeButton === 'Free' && 'bg-[#116E63] text-white'}`}>Kelas Gratis</Button>
      </div>
