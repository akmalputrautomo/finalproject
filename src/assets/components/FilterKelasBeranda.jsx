        ...
        <div className="rounded-lg bg-white px-0 desktop:p-5 space-y-4">
          <div>
            ...
            <div className="pl-1 py-2 space-y-2 text-xs">
              <CheckboxGroup>
                <Checkbox value="baru"><span className="text-sm">Paling Baru</span></Checkbox>
                <Checkbox value="populer"><span className="text-sm">Paling Populer</span></Checkbox>
                <Checkbox value="promo"><span className="text-sm">Promo</span></Checkbox>
              </CheckboxGroup>
            </div>
          </div>
          ...
          <div>
            ...
            {belajar && belajar.map((course) =>
              <CheckboxGroup key={course.id}>
                <Checkbox value="ui/ux" onClick={() => {setId(course.id);}}><span className="text-sm">{course.name}</span></Checkbox>
              </CheckboxGroup>)}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="pl-1 py-2 space-y-2">
              <CheckboxGroup>
                <Checkbox value="ui/ux"><span className="text-sm">Semua Level</span></Checkbox>
                <Checkbox value="web"><span className="text-sm">Beginner Level</span></Checkbox>
                <Checkbox value="android"><span className="text-sm">Intermediate Level</span></Checkbox>
                <Checkbox value="data"><span className="text-sm">Advanced level</span></Checkbox>
              </CheckboxGroup>
            </div>
          </div>
